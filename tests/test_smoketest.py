...
def setup_method(self, method):
  ...
  def test_1(self):
    ...
    self.driver.set_window_size(1140, 796)
  ...
  def test_2(self):
    self.driver.get("http://127.0.0.1:5500/teton/1.6/index.html")
    self.driver.set_window_size(1145, 692)
  ...
  def test_3(self):
    self.driver.get("http://127.0.0.1:5500/teton/1.6/index.html")
    self.driver.set_window_size(1090, 692)
  ...
  def test_4(self):
    ...
    self.driver.find_element(By.NAME, "fname").send_keys("Josue")
    ...
    self.driver.find_element(By.NAME, "bizname").send_keys("Legacy Fence")
  ...
  def test_5(self):
    ...
    assert len(elements) > 0
    self.driver.find_element(By.ID, "username").send_keys("josue")
